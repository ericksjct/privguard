...
- [x] **TEST-07**: Failure-injection, adversarial-evasion, ReDoS, mutation, and property-based tests prove that detector failures and evasion attempts never result in silent pass-through, with a branch-coverage gate enforced from the measured baseline.
